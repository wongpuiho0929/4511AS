...
public class test extends HttpServlet {
    ...
    public static void main(String[] arg) throws SQLException, IOException {
        ...
        pdb.addProduct("P0002", "Nam cursus facilisis", 200.0, 20,"Apple","IS a Pen","pen", "images/product/02.jpg");
        pdb.addProduct("P0003", "Mauris consectetur", 120.5, 20,"Apple","IS a Pen","pen", "images/product/03.jpg");
        pdb.addProduct("P0004", "Proin volutpat", 260.0, 20,"Apple","IS a Pen","pen", "images/product/04.jpg");
        pdb.addProduct("P0005", "Aenean tempus", 80.0, 20,"Apple","IS a Pen","pen", "images/product/05.jpg");
